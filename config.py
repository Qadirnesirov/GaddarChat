...
MONGO_URL = getenv("MONGO_URL", "mongodb+srv://jaspperx:jaspperx123@gaddar.wujzbos.mongodb.net/")
SUPPORT_GRP = getenv("SUPPORT_GRP", "oToBoTBLoG")
UPDATE_CHNL = getenv("UPDATE_CHNL", "otobotresmi")
OWNER_USERNAME = getenv("OWNER_USERNAME", "oToBoToWNeR")
